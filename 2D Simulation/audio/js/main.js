...
function call() {
	...
	// 	'optional': []
	// };
	// pc1 = new RTCPeerConnection({"ws://localhost:8080": servers}, pcConstraints);
	pc1 = JSON.parse(localStorage.getItem("pc1"));
	trace('Created local peer connection object pc1');
	pc1.onicecandidate = function(e) {
		onIceCandidate(pc1, e);
	};
	// pc2 = new RTCPeerConnection({"ws://localhost:8080": servers}, pcConstraints);
	pc2 = JSON.parse(localStorage.getItem("pc2"));
