...
function initInstructions() {
    ...
    introductions1.push("Sorting:<br>&emsp;Your task is to sort the blocks in a particular way.<br>Player 1 Instructions:<br>&emsp;You will decide how you want to sort the block and instruct your partner to move the blocks in order to finish the task. This can be accomplished by speaking to your partner through your device's microphone, or by typing instructions to your partner via the text box. No communication between you and your partner will be sent until the start button has been pressed, and the game has begun. Your partner will be able to hear what you say and see what you type, but will not be able to communicate with you. At any time during the game, you may double-click anywhere on the board to gesture to that location to communicate more effectively with your partner. All actions performed on the board will be seen by both players simultaneously. When you have determined the task has been completed according to your specifications, press the end button to complete the game and have your results recorded.");
    introductions2.push("Sorting:<br>&emsp;Your task is to sort the blocks in a particular way.<br>Player 2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your responsibility will be to follow your partner's instructions as closely as possible. Pay attention to the board, as your partner is able to gesture to locations on the board to help you follow any instructions you are given. All actions performed on the board will be seen by both players simultaneously.<br>");
    introductions1.push("Matching:<br>Your task is to match the blocks in a particular way. Once the game starts, both of you and your partner will flip two separate blocks. If the blocks match, Player 1 will drag both the blocks to the left. If they don't, Player 2 will drag both the blocks to the right. The objective of the task is to flip all the blocks over and move them to their respective sides as quickly as possible.<br>Player 1 Instructions:<br>&emsp;You will decide by what criteria you want to match the blocks and instruct your partner to flip and move the blocks in order to finish the task. This can be accomplished by speaking to your partner through your device's microphone, or by typing instructions to your partner via the text box. No communication between you and your partner will be sent until the start button has been pressed, and the game has begun. Your partner will be able to hear what you say and see what you type, but will not be able to communicate with you. At any time during the game, you may double-click anywhere on the board to gesture to that location to coummunicate more effectively with your partner. All actions performed on the board will be seen by both players simultaneously. When you have determined the task has been completed according to your specifications, press the end button to complete the game and have your results recorded.<br>");
    introductions2.push("Matching:<br>Your task is to match the blocks in a particular way. Once the game starts, both of you and your partner will flip two separate blocks. If the blocks match, Player 1 will drag both the blocks to the left. If they don’t, Player 2 will drag both the blocks to the right. The objective of the task is to flip all the blocks over and move them to their respective sides as quickly as possible.<br>Player 2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your responsibility will be to follow your partner's instructions as closely as possible. Pay attention to the board, as your partner is able to gesture to locations on the board to help you follow any instructions that are given. All actions performed on the board will be seen by both players simultaneously.<br>");
    ...
    introductions2.push("Searching:<br>Your task is to search for blocks on the board in order to create a pair of words.<br>Player 2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your responsibility will be to follow your partner's instructions as closely as possible. Pay attention to the board, as your partner is able to gesture to locations on the board to help you follow any instructions you are given. All actions performed on the board will be seen by both players simultaneously.<br>");
    introductions1.push("Rainbow:<br>Your task is to create a specific pattern (like a triangle) using the blocks, along with your partner.<br>Player 1 Instructions:<br>&emsp;You will decide what pattern you want to create with the blocks and provide instructions for your partner to move the blocks in order to finish the task. Both you and your partner are permitted to move the blocks in any way you choose, but it is encouraged that both of you move half of the blocks each in order to complete the pattern. This can be accomplished by speaking to your partner through your device’s microphone, or by typing instructions to your partner via the text box. No communication between you and your partner will be sent until the start button has been pressed, and the game has begun. Your partner will be able to hear what you say and see what you type, but will not be able to communicate with you. At any time during the game, you may double-click anywhere on the board to gesture to that location to communicate more effectively with your partner. All actions performed on the board will be seen by both players simultaneously. When you have determined the task has been completed according to your specifications, press the end button to complete the game and have your results recorded.<br>");
    introductions2.push("Rainbow:<br>Your task is to create a specific pattern (like a triangle) using the blocks, along with your partner.<br>Player 2 Instructions:<br>&emsp;Your partner will give you instructions to complete the task. Your responsibility will be to follow your partner's instructions as closely as possible. Pay attention to the board, as your partner is able to gesture to locations on the board to help you follow any instructions you are given. All actions performed on the board will be seen by both players simultaneously.<br>");
}
